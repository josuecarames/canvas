...
INNER JOIN account_dim ON account_dim.id = course_score_fact.account_id
INNER JOIN enrollment_dim ON enrollment_dim.id = course_score_fact.enrollment_id
INNER JOIN course_dim ON course_dim.id = course_score_fact.course_id
